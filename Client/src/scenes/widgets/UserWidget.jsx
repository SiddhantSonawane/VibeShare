...
const UserWidget = ({ userId, picturePath, editProfileIcon }) => {
  ...
  const main = palette.neutral.main;
    ...
    const impressionsCount = async() => {
        const response = await fetch(`http://localhost:3001/user/impressions/${userId}`, 
            {
                method: "PATCH",
                headers: {
                    Authorization: `Bearer ${token}`
    ...
    return (
        <WidgetWrapper>
            ...
            >
                ...
                <Box>
                    <Box display="flex" alignItems="center" gap="1rem" mb="0.5rem" mt="0.5rem">
                ...
                <Box p ="1rem 0">
                    ...
                    <FlexBetween>
                        <Typography color={medium}>Total Impressions of your Posts</Typography>
                    ...
                    <FlexBetween gap="1rem" mb="1rem">
                        <FlexBetween gap="1rem">
                            ...
                            <Box>
                                ...
                                <Typography color={medium}> {user.socialProfiles[0].twitterProfile} </Typography>
                            </Box>
                        </FlexBetween>
                    </FlexBetween>
                    ...
                    <FlexBetween gap="1rem" mb="1rem">
                        <FlexBetween gap="1rem">
                            ...
                            <Box>
                                ...
                                <Typography color={medium}> {user.socialProfiles[0].linkedInProfile} </Typography>
                            </Box>
                        </FlexBetween>
                    </FlexBetween>
                    ...
                    <FlexBetween gap="1rem">
                        <FlexBetween gap="1rem">
                            ...
                            <Box>
                                ...
                                <Typography color={medium}> {user.socialProfiles[0].instagramProfile} </Typography>
                            </Box>
                        </FlexBetween>
                    </FlexBetween>
                </Box>
